...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-[#25a3e9] to-[#061c57] text-white pb-24 font-quicksand">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Satisfy&family=Quicksand:wght@300;400;600;700&display=swap');
        
        .font-playfair { font-family: 'Satisfy', cursive; }
        .font-quicksand { font-family: 'Quicksand', sans-serif; }

        .text-shadow-3d {
          text-shadow: 2px 2px 4px rgba(0,0,0,0.4), 0px 0px 10px rgba(0,0,0,0.3);
        }
        ...
        <div className="flex items-center py-3">
          {navItems.map((item) => (
            <button
              ...
              className="group flex flex-1 flex-col items-center gap-1 px-1 transition-all duration-300 transform"
            >
              <item.Icon
                className={`w-6 h-6 transition-colors duration-300 ${currentPage === item.page ? 'text-[#D4AF37]' : 'text-white/40 group-hover:text-[#D4AF37]'
                  }`}
              />
              {/* MODIFICA: Font Quicksand, grassetto, tutto maiuscolo per il menu */}
              <span
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="border-4 border-white p-8 bg-white/5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-white text-[#0b46d0] px-12 py-4 text-xl font-bold font-quicksand hover:bg-[#0b46d0] hover:text-white transition-all transform hover:scale-105"
              >
                PRENOTA ORA
              </a>
            </div>
            ...
            <div className="mt-12 flex flex-col items-center gap-8">
              ...
              <div className="max-w-2xl w-full">
                ...
                <div className="text-center mt-6">
                  <a href="https://wa.me/393922752576" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-white text-[#0b46d0] px-12 py-4 text-xl font-bold font-quicksand hover:bg-[#D4AF37] hover:text-white transition-all transform hover:scale-105">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="space-y-12 text-lg mb-12 max-w-md mx-auto">
              ...
              <div className="flex items-start gap-4 text-left">
                <Instagram className="w-6 h-6 text-white mt-1" />
                <div className="font-quicksand">
