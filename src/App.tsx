...
function App() {
  ...
  // Classe CSS comune per i bordi delle immagini (Aggiornato a #daa520)
  const imageBorderClass = "border-4 border-white hover:border-[#daa520] active:border-[#daa520] transition-colors duration-300 shadow-lg";
    ...
    <div className="min-h-screen bg-[linear-gradient(to_bottom,#b0ddf6_0%,#25a3e9_25%,#003ba3_50%,#061c57_75%,#112149_100%)] text-white pb-24 font-montserrat">
      ...
      {modalGallery && (
        ...
        >
          <button
            onClick={() => setModalGallery(null)}
            className="absolute top-4 right-4 text-white hover:text-[#daa520] transition-colors z-50"
          >
          ...
          {modalGallery.images.length > 1 && (
            <button
              ...
              className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 text-white p-2 rounded-full bg-white/10 hover:bg-[#daa520]/20 transition-all disabled:opacity-30 disabled:cursor-not-allowed z-50"
            >
          ...
          >
            <img
              ...
              alt="Ingrandimento"
              className="w-full h-auto object-contain max-h-[90vh] border-2 border-[#daa520]/40"
            />
          </div>
          ...
          {modalGallery.images.length > 1 && (
            <button
              ...
              className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 text-white p-2 rounded-full bg-white/10 hover:bg-[#daa520]/20 transition-all disabled:opacity-30 disabled:cursor-not-allowed z-50"
            >
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 bg-black/60 backdrop-blur-md border-t border-white/20">
        <div className="flex items-center py-3">
          {navItems.map((item) => (
            ...
            >
              <item.Icon
                className={`w-6 h-6 transition-colors duration-300 ${currentPage === item.page ? 'text-[#daa520]' : 'text-white/40 group-hover:text-[#daa520]'
                  }`}
              />
              <span
                className={`font-montserrat text-[10px] uppercase tracking-widest mt-1 transition-colors duration-300 ${currentPage === item.page ? 'text-[#daa520]' : 'text-white/40 group-hover:text-[#daa520]'
                  }`}
              >
                {item.label}
              </span>
      ...
      {currentPage === 1 && (
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="border-t border-b border-white/20 py-8 mb-10 text-white">
              ...
              <a
                ...
                className="inline-block mt-5 text-white hover:text-[#daa520] transition-all duration-300 underline decoration-white/30 font-montserrat"
              >
                Apri su Google Maps →
              </a>
            </div>
            ...
            <div className="border-4 border-white p-8 bg-white/5 text-white text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-white text-[#0b46d0] px-12 py-4 text-xl font-montserrat hover:bg-[#daa520] hover:text-black transition-all transform hover:scale-105 shadow-lg"
              >
                PRENOTA ORA
              </a>
            </div>
      ...
      {currentPage === 2 && (
        <section className="min-h-screen flex flex-col items-center px-6 py-20">
          <div className="max-w-4xl mx-auto w-full">
            <h2 className="font-pinyon text-7xl text-[#daa520] mb-12 tracking-wider border-b-2 border-[#daa520] pb-4 text-center text-shadow-3d">
              Il Cast
            </h2>
            ...
            <div className="mb-24 text-center">
              ...
              <div className="text-white">
                <p className="text-2xl md:text-3xl font-garamond text-[#daa520] uppercase tracking-widest mb-2">PRODUCER</p>
            ...
            <div className="mb-24 text-center">
              ...
              <div className="text-white">
                <p className="text-2xl md:text-3xl font-garamond text-[#daa520] uppercase tracking-widest mb-2">THE GODMOTHER</p>
                ...
                <p className="text-xl md:text-2xl font-garamond italic text-[#daa520] mt-8 text-center">Elegance. Charm. Seduction.</p>
              </div>
            </div>
            ...
            <div className="mb-24 text-center">
              ...
              <div className="text-white">
                <p className="text-2xl md:text-3xl font-garamond text-[#daa520] uppercase tracking-widest mb-2">THE HOST</p>
                ...
                <p className="text-xl md:text-2xl font-garamond italic text-[#daa520] mt-8 text-center">Energy. Rhythm. Show.</p>
              </div>
            </div>

            <div className="space-y-8 mt-16 text-center">
              <div>
                <button onClick={() => toggleSection('performer')} className="w-full flex justify-center items-center font-garamond text-3xl border-b border-white/20 pb-3 text-white hover:text-[#daa520] active:text-[#daa520] transition-colors duration-300">
      ...
      {currentPage === 3 && (
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-pinyon text-7xl text-[#daa520] mb-4 border-b-2 border-[#daa520] pb-4 text-shadow-3d">
              Workshop
            </h2>
      ...
      {currentPage === 4 && (
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
          <div className="w-full max-w-2xl mx-auto flex flex-col items-center">
            ...
            <h2 className="font-pinyon text-6xl md:text-7xl text-[#daa520] mb-16 tracking-wider text-shadow-3d text-center w-full">
            ...
            <div className="space-y-10 w-full max-w-fit">
              ...
              <div className="flex items-start gap-4">
                <MapPin className="w-6 h-6 text-[#daa520] flex-shrink-0 mt-1 filter drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                <div className="text-left">
                  <p className="font-garamond text-[#daa520] tracking-widest text-sm md:text-base uppercase text-shadow-3d">LOCATION:</p>
              ...
              {/* PAGINA UFFICIALE */}
              <div className="flex items-start gap-4">
                <Instagram className="w-6 h-6 text-[#daa520] flex-shrink-0 mt-1 filter drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                <div className="text-left">
                  <p className="font-garamond text-[#daa520] tracking-widest text-sm md:text-base uppercase text-shadow-3d">PAGINA UFFICIALE:</p>
                  <a
                    href={instagramUrl}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="flex items-start gap-4">
                <Instagram className="w-6 h-6 text-[#daa520] flex-shrink-0 mt-1 filter drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                <div className="text-left">
                  <p className="font-garamond text-[#daa520] tracking-widest text-sm md:text-base uppercase text-shadow-3d">DIREZIONE ARTISTICA:</p>
                  <a
              ...
              {/* EMAIL */}
              <div className="flex items-start gap-4">
                <Mail className="w-6 h-6 text-[#daa520] flex-shrink-0 mt-1 filter drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                <div className="text-left">
                  <p className="font-garamond text-[#daa520] tracking-widest text-sm md:text-base uppercase text-shadow-3d">EMAIL:</p>
                  <a
